<div>
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <h1 class="text-xl font-bold uppercase">Create Course Examination</h1>
    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div x-data="{ mode: 'view', questionID: '' }" x-on:course-question-updated.window="questionID = ''"
                    class="p-6 text-gray-900 dark:text-gray-100">
                    {{-- Action Buttons --}}
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-xl font-bold uppercase">COURSE QUESTION LIST:</h1>
                        </div>
                        <div>
