<div>
    ...
    <x-sweet-alert-2 on="question-deleted" message="Question Deleted Successfully" />
    <x-sweet-alert-2 on="question-added" message="Question Added Successfully" />
    <x-sweet-alert-2 on="question-updated" message="Question Updated Successfully" />
    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div x-data="{ mode: 'view', questionID: '' }" class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div>
                            ...
                            <button type="button" @click="mode = 'edit'"
                                x-show="(mode === 'view') || (mode === 'edit') || (mode === 'delete')"
                            ...
                            <button type="button" @click="mode = 'delete'"
                                x-show="(mode === 'view') || (mode === 'delete') || (mode === 'edit')"
                            ...
                            {{-- Back To Menu --}}
                            <button type="button" @click="mode = 'view'" x-show="mode != 'view'"
