<div>
    ...
    {{-- FIRST SECTION - CREATE FLASHCARD --}}
    <div class="py-12">
    ...
    {{-- SECOND SECTION - DISPLAY FLASHCARDS --}}
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                    ...
                    <div class="space-y-4 text-gray-500 break-words  dark:text-gray-100 ">
                        ...
                        @forelse ($fetched_flashcards as $flashcard)
                            ...
                            <div wire:key="{{ $flashcard->id }}" class="flex w-full break-words  ">
                                {{-- Edit Icon --}}
                                <span class="me-2 " x-show="mode == 'edit' && (flashcardID !== {{ $flashcard->id }})">
                                ...
                                <form class="w-full" wire:submit.prevent="updateAFlashcard({{ $flashcard->id }})">
                                    <div
                                        ...
                                        <h5 x-show="(mode == 'view') || ((mode == 'edit') && (flashcardID != {{ $flashcard->id }}))"
                                        ...
                                        {{-- View Mode of Answer --}}
                                        <p x-show="(mode == 'view') || ((mode == 'edit') && (flashcardID != {{ $flashcard->id }}))"
