<div x-data="{
    ...
    <div class="relative">
        {{-- START - MOON ICON --}}
        <button @click="setLightMode()" x-show="theme === 'dark'" class="cursor-pointer peer ">
        ...
        <div
            class="absolute z-50 hidden px-2 py-1 text-sm text-center text-white transition-all ease-out -translate-x-1/2 rounded top-9 left-1/2 whitespace-nowrap bg-slate-900 peer-hover:block dark:bg-gray-700 dark:text-gray-200">
    ...
    <div class="relative">
        {{-- START - SUN ICON  --}}
        <button @click="setDarkMode()" x-show="theme!== 'dark'" class="cursor-pointer peer ">
        ...
        <div
            class="absolute z-50 hidden px-2 py-1 text-sm text-center text-white transition-all ease-out -translate-x-1/2 rounded top-9 left-1/2 whitespace-nowrap bg-slate-900 peer-hover:block dark:bg-white dark:text-black">
            Switch To Dark Mode
        </div>
        {{-- END - SUN ICON --}}
    </div>
