@props(['name', 'show' => false, 'maxWidth' => '2xl', 'bgColor' => 'bg-gray-500 dark:bg-gray-900'])
...
<div x-data="{
    ...
    <div x-show="show"
        class="mb-6 {{ $bgColor ? $bgColor : '' }} rounded-lg overflow-hidden transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto"
