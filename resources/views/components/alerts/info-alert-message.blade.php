...
<div x-data="{ alertIsVisible: true }" x-show="alertIsVisible"
    {{ $attributes->merge(['class' => 'relative w-10/12 mx-auto my-4 overflow-hidden rounded-xl border border-sky-600 bg-white text-slate-700 dark:bg-slate-900 dark:text-slate-300']) }}
    ...
    <div class="flex w-full items-center gap-2 bg-sky-600/10 p-4">
        ...
        {{-- Content --}}
        <div class="ml-2">
            <h3 class="text-sm font-semibold text-sky-600">Information</h3>
